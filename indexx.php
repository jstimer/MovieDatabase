...
<a href="indexx.php?letter=">View All</a>
</form>
...
?>
<tr>
<td align="center"><a href="single.php?filmName=<?php echo $name ?>"><?php echo $row["film_name"] ?></br></a></td>
...
{
$query = "SELECT * FROM Film ORDER BY film_name";
$result = mysql_query($query);
?>
<center>
<table cellpadding="1" cellspacing="0" border="1" width="35%" >
